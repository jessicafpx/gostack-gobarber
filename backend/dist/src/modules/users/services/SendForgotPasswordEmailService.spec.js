...
describe('SendForgotPasswordEmail', function () {
    ...
    it('shoul not be able to recover a non-existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should generate a token password token', function () { return __awaiter(void 0, void 0, void 0, function () {
